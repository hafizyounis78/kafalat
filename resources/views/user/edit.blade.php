            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input name="name" type="text" class="form-control input-circle"
                                       placeholder="الاسم" value="{{$one_user->name}}"></div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input name="email" type="email" class="form-control input-circle-right"
                                       placeholder="البريد الإلكتروني" value="{{$one_user->email}} " disabled></div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <input id="password" name="password" type="password"
                                       ...
                                       placeholder="كلمة الرور" value="{{$one_user->password}}">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                <input name="confirm_password" type="password" class="form-control input-circle-left"
                                       placeholder="تأكيد كلمة المرور" value="{{$one_user->password}}">
                                <span class="input-group-addon input-circle-right">
                                                                            <i class="fa fa-user"></i>
                                                                        </span>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select id="user_type" name="user_type" class="form-control select2 hselect">
                                ...
                                <option value="1" <?php if ($one_user->user_type == 1) echo "selected"; ?> >مدير
                                    النظام
                                </option>
                                <option value="2" <?php if ($one_user->user_type == 2) echo "selected"; ?>> مشرف
                                <option value="3" <?php if ($one_user->user_type == 3) echo "selected"; ?>> باحث
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select class="form-control select2 hselect" name="title_id" id="title_id"
                                    onchange="check_user();">
                                <option value="">اختر ..</option>
                                <?php
                                $selected = '';
                                foreach ($titles as $title) {
                                    $selected = '';
                                    if ($one_user->title_id == $title->id)
                                        $selected = 'selected="selected"';
                                    echo '<option value="' . $title->id . '" ' . $selected . ' >' . $title->lookup_cat_details . '</option>';
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3">المحافظة<span
                                class="required"> * </span></label>
                        <div class="col-md-4">
                            <select id="district_id" class="form-control select2-multiple hselect" name="district_id[]"
                                    multiple>
                                <option value="">اختر ..</option>
                                <?php
                                $selected = '';
                                foreach ($districts as $district) {
                                    ...
                                    foreach ($user_districts as $user_district) {
                                        ...
                                        if ($user_district->district_id == $district->id)
                                            $selected = 'selected="selected"';


                                    }
                                    echo '<option value="' . $district->id . '" ' . $selected . ' >' . $district->lookup_cat_details . '</option>';
                                }
                        ...
                        <div class="col-md-4">
                            <div class="input-icon  input-group col-md-12">
                                ...
                                <input name="address" type="text" class="form-control input-circle"
                                       placeholder="العنوان" value="{{$one_user->address}}"></div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="input-icon  input-group col-md-12">
                                ...
                                <input name="mobile" type="text" class="form-control input-circle"
                                       placeholder="جوال" value="{{$one_user->mobile}}"></div>
                        </div>
                    </div>
                    <?php
                    $img_file = url('public/storage/') . '/' . $one_user->user_image;
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            ...
                            <a href="{{url('/user')}}" class="btn btn-circle grey-salsa btn-outline">عودة</a>
                        </div>
                    </div>
                </div>
            {{-- </form>--}}
    ...
    @push('js')
        ...
        <script>
            $(document).ready(function () {
                ...
                check_user({{$one_user->supervised_by,$one_user->id}});
            })
                ...
                var handleValidation = function () {
                    ...
                    $.validator.addMethod(
                        ...
                        function (value, element) {
                            var option = $("#element[] option:selected").length;
                            if (option == 0)
                                return false;
                            return true;
                    ...
                    form3.validate({
                        ...
                        messages: { // custom messages for radio buttons and checkboxes
                            ...
                            /*user_image: {
                                required: "هذه الحقل مطلوب,الرجاء اختيار صورة",

                            },*/
                            district_id: {
                                multiSelectValidate: "هذه الحقل مطلوب,الرجاء اختيار قيمة",
            ...
            function check_user(supervised_by=null,user_id=null) {
                ...
                if ($('#title_id').val() == 82 || $('#title_id').val() == 177) {
                    ...
                    $.ajax({
                        ...
                        data: {title_id: $('#title_id').val(),
                            supervised_by:supervised_by,user_id:user_id},
            ...
            /*  function check_user() {
                  ...
                  if ($('#user_type').val() == 3) {
                      ...
                      $('#supervised_by').val('0').trigger('change');
                      $('#superDV').css('display', 'block');

                  }
                  else {
                      $('#supervised_by').val('0').trigger('change');
                      $('#superDV').css('display', 'none');
