    ...
    <div class="page-content">
        ...
        <div class="portlet box green">
            ...
            <div class="portlet-body form">
                ...
                {{Form::open(['url'=>url('admin/setting/s3-save'),'class'=>'form-horizontal','method'=>"post","id"=>"setting_form"])}}
        ...
        <script type="text/javascript">
                        ...
                        success:
                            ...
                            function (data) {
                                if (data.success) {
                                    ...
                                    window.location.href = '{{url('admin/setting/s3')}}';
            ...
            function settingDelete(id) {
                ...
                if (x == 1) {
                    ...
                    $.ajax({
                            type: "POST",
                            url: '{{url('admin/setting/s3-delete')}}',
                            data: {id: id},
